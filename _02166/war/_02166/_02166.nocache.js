...
(function($wnd, $doc){
  ...
  var badBrowser = 'Unable to load Super Dev Mode of "_02166" because\n';
  ...
  $wnd.__gwt_activeModules['_02166'] = {
    'moduleName' : '_02166',
    'bindings' : function() {
      return {};
    }
 ...
 * "/_02166.nocache.js" is the one that loaded us. Normally this happens
...
function computeScriptBase() {
  ...
  $wnd.__gwt_activeModules['_02166'].superdevmode = true;

  var expectedSuffix = '/_02166.nocache.js';
  ...
  $wnd.alert('Unable to load Super Dev Mode version of ' + _02166 + ".");
}
;
  ...
  var devModeHookKey = '__gwtDevModeHook:_02166';
  var devModeSessionKey = '__gwtDevModeSession:_02166';

  // Compute some codeserver urls so as the user does not need bookmarklets
  var hostName = $wnd.location.hostname;
  var serverUrl = 'http://' + hostName + ':9876';
  var nocacheUrl = serverUrl + '/_02166/_02166.nocache.js';
  ...
  $wnd.__gwt_activeModules['_02166'].canRedirect = true;
  $wnd.__gwt_activeModules['_02166'].superdevmode = true;
  ...
  $wnd[compileFunction] = function() {
    ...
    compileScript.src = serverUrl +
      '/recompile/_02166?user.agent=' + ua + '&_callback=' + callback;
